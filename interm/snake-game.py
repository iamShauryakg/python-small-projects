# trying to create a small snake game with the help of tkinter 
...
def game_over():
    canvas.delete(ALL)
    canvas.create_text(canvas.winfo_width()/2, canvas.winfo_height()/2, font= ('consolas', 50), text= 'game over', fill='red', tag='game-over')
